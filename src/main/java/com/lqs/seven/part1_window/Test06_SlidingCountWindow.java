...
/**
 * @Author lqs
 * @Date 2022年03月30日 18:21:57
 * @Version 1.0.0
 * @ClassName Test06_SlidingCountWindow
 * @Describe 使用滑动窗口统计个数
 * 和滚动窗口计数使用的函数名一样，只是多了滑动步长
 * countWindow(5,2)
 */
public class Test06_SlidingCountWindow {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //TODO 5、使用基于元素个数的滑动动窗口，窗口大小为5，滑动步长为2
        ...
        env.execute("SlidingCountWindow");
