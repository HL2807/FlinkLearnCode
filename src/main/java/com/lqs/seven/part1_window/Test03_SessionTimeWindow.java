...
/**
 * @Author lqs
 * @Date 2022年03月30日 17:58:04
 * @Version 1.0.0
 * @ClassName Test03_SessionTimeWindow
 * @Describe 会话窗口(Session Windows)静态gap
 */
public class Test03_SessionTimeWindow {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //TODO 5、开启一个基于时间的会话窗口，会话间隔5s（静态间隔）
