...
/**
 * @Author lqs
 * @Date 2022年04月01日 21:09:50
 * @Version 1.0.0
 * @ClassName Test03_SlidingEventTImeWaterMarkBounded
 * @Describe Fixed Amount of Lateness(允许固定时间的延迟)
 * 基于时间的滑动窗口
 */
public class Test03_SlidingEventTImeWaterMarkBounded {
    ...
    public static void main(String[] args) throws Exception {
        ...
        WindowedStream<WaterSensor, Tuple, TimeWindow> window = keyedStream.window(
                SlidingEventTimeWindows.of(Time.seconds(4),Time.seconds(2))
        );
